...
class RAFTStereo(nn.Module):
    def __init__(self, args):
        ...
        self.update_block = BasicMultiUpdateBlock(args, hidden_dims=args.hidden_dims)
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, test_mode=False):
        ...
        # print('fmap1, {}'.format(fmap1.shape))
        # print('fmap2, {}'.format(fmap2.shape))
        ...
        for itr in range(iters):
            ...
            # print('flow up before index {}'.format(flow_up.shape))
            flow_up = flow_up[:,:1]
            # print('flow up after index {}'.format(flow_up.shape))
