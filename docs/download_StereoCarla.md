...
5. Please cite our paper if the StereoCarla dataset is useful to your research:
```
...
# Dataset Access
1. All users can obtain and use this dataset and its subsets only after signing the [Agreement](license_agreement_for_StereoCarla_dataset.pdf) and sending it to the official contact email address.
...
3. Please send the signed Agreement to the official contact email (xianda_guo@163.com) in the form of a scanned copy. Please CC the Responsible Party when sending the email.
4. Email format for StereoCarla dataset application:
Subject: StereoCarla Dataset Application
CC: The email address of the Responsible Party
Attachment: license_agreement_for_StereoCarla_dataset.pdf (scanned copy)

If you want to download the StereoCarla dataset, please send an email to (xianda_guo@163.com)
